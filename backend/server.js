...
import Accommodation from "../src/pages/ecoOptions/data/Accommodation.js";
import Activity from "../src/pages/ecoOptions/data/Activity.js";
import Restaurant from "../src/pages/ecoOptions/data/Restaurant.js";
import Transportation from "../src/pages/ecoOptions/data/Transportation.js";
...
app.get("/api/serp/search", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to fetch from SerpAPI", err: err.message });
