...
const SignIn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Add your login logic here boss
  };
          ...
          <div className="bg-image h-100" style={{
            ...
            <div className="mask h-100 w-100" style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }}>
              <div className="d-flex flex-column justify-content-center align-items-center h-100 text-white p-4">
                ...
                <p className="lead text-center">Continue your sustainable travel journey with us</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-6 d-flex align-items-center justify-content-center p-4">
          <div className="w-100" style={{ maxWidth: '450px' }}>
            ...
            <div className="d-flex mb-4">
              <a href="/signup" className="btn btn-outline-secondary flex-grow-1">Sign Up</a>
              <button className="btn btn-outline-secondary flex-grow-1 active">Login</button>
            </div>
            ...
            <div>
              ...
              <button onClick={handleSubmit} className="btn btn-success w-100 py-2 mb-3">Sign In</button>
